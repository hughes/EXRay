...
- flexible, loading large images easily
- supports arbitrary dynamic range
- ergonomic scaling and scrolling of image *and* light
- useful metadata output and handy analysis tools, including histograms and  pixel value peeking
- HDR display support
